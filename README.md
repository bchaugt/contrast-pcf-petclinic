...
#(new prompts will ask you for the TeamServer URL, username, api_key, service_key.  Make sure username and service key are for the same username. i.e. brian.chau@contrastsecurity.com and api_key is available in profile section)
